...
1. **Add dependency** — add `ratex_flutter: ^0.0.13` to `pubspec.yaml`, then run `flutter pub get`. No native build required — the published package includes prebuilt Android `.so` and iOS XCFramework.
